...
INTEGER, PARAMETER :: N_ONE_D_SCALAR_REALS=23,N_ONE_D_SCALAR_INTEGERS=10,N_ONE_D_SCALAR_LOGICALS=2
...
TYPE ONE_D_M_AND_E_XFER_TYPE
   ...
   REAL(EB), POINTER :: AREA,HEAT_TRANS_COEF,QCONF,QRADIN,QRADOUT,EMISSIVITY,AREA_ADJUST,T_IGN,TMP_F,TMP_B,UW,UWS,&
                        RSUM_G,TMP_G,RHO_G,U_TANG,RHO_F,RDN,MU_G,K_G,U_TAU,Y_PLUS,Z_STAR
...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=10,N_WALL_SCALAR_INTEGERS=15,N_WALL_SCALAR_LOGICALS=0

TYPE WALL_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: A_LP_MPUA,AWM_AEROSOL,LP_CPUA,LP_MPUA,VEG_FUELMASS_L,VEG_MOISTMASS_L,VEG_TMP_L
   REAL(EB), POINTER :: DUWDT,EW,Q_LEAK,UW0,V_DEP,VEG_HEIGHT,VEL_ERR_NEW,X,Y,Z
...
INTEGER, PARAMETER :: N_CFACE_SCALAR_REALS=10,N_CFACE_SCALAR_INTEGERS=5,N_CFACE_SCALAR_LOGICALS=0

TYPE CFACE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: AWM_AEROSOL
   REAL(EB), POINTER :: AREA,X,Y,Z,NVEC(:),UW0,VEL_ERR_NEW,V_DEP
